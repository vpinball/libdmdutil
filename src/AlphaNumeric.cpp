...
uint8_t* AlphaNumeric::Render(AlphaNumericLayout layout,
                              const uint16_t* const seg_data) {
...
void AlphaNumeric::DrawSegment(const int x, const int y, const uint8_t type,
...
void AlphaNumeric::DrawPixel(const int x, const int y, const uint8_t colour) {
  m_frameBuffer[y * 128 + x] = colour;
}
...
void AlphaNumeric::Render2x7Alpha_2x7Num_4x1Num(
    const uint16_t* const seg_data) {
  for (int i = 0; i < 14; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x7 alphanumeric
...
void AlphaNumeric::Render2x6Num10_2x6Num10_4x1Num(
    const uint16_t* const seg_data) {
  for (int i = 0; i < 12; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x6 numeric
...
void AlphaNumeric::Render2x7Num_2x7Num_10x1Num(
    const uint16_t* const seg_data, const uint16_t* const extra_seg_data) {
  for (int i = 0; i < 14; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x7 numeric
      if ((seg_data[i] >> j) & 0x1)
...
void AlphaNumeric::Render2x7Num_2x7Num_4x1Num_gen7(
    const uint16_t* const seg_data) {
  for (int i = 0; i < 14; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x7 numeric
...
void AlphaNumeric::Render2x7Num10_2x7Num10_4x1Num(
    const uint16_t* const seg_data) {
  for (int i = 0; i < 14; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x7 numeric
...
void AlphaNumeric::Render2x7Num_4x1Num_1x16Alpha(
    const uint16_t* const seg_data) {
  for (int i = 0; i < 14; i++) {
    for (int j = 0; j < 16; j++) {
      // 2x7 numeric
...
void AlphaNumeric::Render1x16Alpha_1x16Num_1x7Num(
    const uint16_t* const seg_data) {
  // 1x16 alphanumeric
  for (int i = 0; i < 16; i++) {
    for (int j = 0; j < 16; j++) {
...
void AlphaNumeric::Render1x7Num_1x16Alpha_1x16Num(
    const uint16_t* const seg_data) {
  // 1x16 alphanumeric
  for (int i = 0; i < 16; i++) {
    for (int j = 0; j < 16; j++) {
...
void AlphaNumeric::Render1x16Alpha_1x16Num_1x7Num_1x4Num(
    const uint16_t* const seg_data) {
  // 1x16 alphanumeric
  for (int i = 0; i < 16; i++) {
    for (int j = 0; j < 16; j++) {
