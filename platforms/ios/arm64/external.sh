...
cp -a third-party/build-libs/ios/arm64/libsockpp.a ${PPUC_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cp build/libzedmd.a ${PPUC_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cp -r test ../../
cd ..
...
cp build/libserum.a ${PPUC_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
...
cp build/libpupdmd.a ${PPUC_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
...
cp build/libvni.a ${PPUC_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
