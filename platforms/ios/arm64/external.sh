...
cp -a third-party/build-libs/ios/arm64/libsockpp.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cp build/libzedmd.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cp -r test ../../
cd ..
...
cp build/libserum.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
...
cp build/libpupdmd.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
...
cp build/libvni.a ${PROJECT_SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd ..
