...
cp -a libusb/.libs/libusb-1.0.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp third-party/runtime-libs/linux/x64/libcargs.so ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a third-party/runtime-libs/linux/x64/libserialport.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a third-party/runtime-libs/linux/x64/libsockpp.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a build/libzedmd.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -r test ../../
cd ..
...
cp -a build/libserum.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp -a build/libpupdmd.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp -a build/libvni.{so,so.*} ${PPUC_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
