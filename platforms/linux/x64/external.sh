...
cp -a libusb/.libs/libusb-1.0.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp third-party/runtime-libs/linux/x64/libcargs.so ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a third-party/runtime-libs/linux/x64/libserialport.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a third-party/runtime-libs/linux/x64/libsockpp.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -a build/libzedmd.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cp -r test ../../
cd ..
...
cp -a build/libserum.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp -a build/libpupdmd.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
...
cp -a build/libvni.{so,so.*} ${PROJECT_SOURCE_ROOT}/third-party/runtime-libs/linux/x64/
cd ..
